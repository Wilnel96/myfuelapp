/*
  # Update create_garage_with_organization to set organization_type

  1. Changes
    - Set organization_type = 'garage' when creating garage organization
    - This ensures garages are properly distinguished from client organizations
*/
...
BEGIN
  ...
  -- Create organization with type 'garage'
  INSERT INTO organizations (name, vat_number, city, province, organization_type)
  VALUES (p_org_name, p_org_vat_number, p_org_city, p_org_province, 'garage')
  RETURNING id INTO v_org_id;

  -- Insert garage with explicit column mapping
  INSERT INTO garages (
    id,
    organization_id,
    name,
